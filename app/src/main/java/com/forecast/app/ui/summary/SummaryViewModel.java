...
public class SummaryViewModel extends AndroidViewModel {
    ...
    /**
     * Loads today's productivity summary.
     * Call this from SummaryFragment.onViewCreated() and onResume().
     */
    public void loadTodaySummary() {
        ...
        repository.getTodaySummary(result -> {
            // Post back to main thread since repository runs on background thread
            mainHandler.post(() -> {
    ...
    /**
     * Refreshes the summary (same as load, exposed separately for pull-to-refresh).
     */
    public void refresh() {
        loadTodaySummary();
    }
